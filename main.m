...
Function_name='TEST'; % Name of the test function that can be from F1 to F23 (Table 1,2,3 in the paper)
...
switch  Function_name
    case 'TEST'
      semilogy(GWO_cg_curve,'Color','r')  % or semilogy(GWO_cg_curve,'Color','r') or plot(GWO_cg_curve)
    otherwise  
